...
const Home = () => {
    ...
    const rooms = [
        ...
        },
        {
            ...
            description: 'Superior Double Rooms are perfectly equipped for traveling couples or friends and have many facilities.',
        ...
        },
        {
            ...
            description: ' Have lots of in-room facilities and are designed in open-concept living area for family.',
